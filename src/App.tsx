          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <section className="bg-[#151515] p-5 rounded-2xl border border-[#333]">
              ...
              <div className="flex items-center gap-3">
                <button
                  onClick={() =>
                    setPurchasedBlocks(Math.max(0, purchasedBlocks - 1))
                  }
          ...
          <div className="space-y-6 animate-fade-in">
              ...
              <div className="flex gap-4 items-end">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    value={balance.hours}
                    onChange={(e) =>
                      handleBalanceChange('hours', e.target.value)
                    }
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleBalanceChange('minutes', e.target.value)
                    }
                    className="w-full bg-[#0a0a0a] text-3xl sm:text-4xl font-mono font-bold text-white border-b-2 border-[#333] focus:border-[#76b900] focus:outline-none py-2 text-center transition-colors placeholder-gray-700"
                    placeholder="00"
                  />
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p
                    className={`font-bold ${calculatedData.planDetails.color}`}
                  >
